...
class AttendanceMonthlySummaryApiIntegrationTests {
    ...
    void seed() {
        ...
        jdbcTemplate.update("INSERT INTO hr_department (id, code, name, path, effective_date, status) VALUES (?, 'SUMMARY_TEST', 'Summary Department', ?, ?, 'ACTIVE')", DEPARTMENT_ID, "/97002/", LocalDate.of(2026, 1, 1));
        jdbcTemplate.update("INSERT INTO hr_position (id, code, name, status) VALUES (?, 'SUMMARY_POSITION', 'Summary Position', 'ACTIVE')", POSITION_ID);
        jdbcTemplate.update("INSERT INTO hr_employee (id, employee_no, name, department_id, position_id, employment_status, hire_date) VALUES (?, 'E-SUM-001', 'Summary Employee', ?, ?, 'FORMAL', ?)", EMPLOYEE_ID, DEPARTMENT_ID, POSITION_ID, LocalDate.of(2025, 1, 1));
        jdbcTemplate.update("INSERT INTO att_leave_type (id, code, name, deduct_balance, min_unit_hours, status) VALUES (?, 'SUMMARY_ANNUAL', 'Summary Annual', 1, 1.00, 'ACTIVE')", LEAVE_TYPE_ID);
