...
class AttendanceMonthlySummaryApiIntegrationTests {
    ...
    void seed() {
        ...
        jdbcTemplate.update("INSERT INTO att_leave_type (id, code, name, deduct_balance, min_unit_hours, status) VALUES (?, 'SUMMARY_ANNUAL', '年假（汇总）', 1, 1.00, 'ACTIVE')", LEAVE_TYPE_ID);
