...
import type { CreateEmployeePayload, CreatePositionPayload, CreateRankPayload, CreatedEmployeeAccount, DepartmentNode, EmployeeDetail, EmployeePage, EmployeeQuery, Position, Rank, UpdateEmployeePayload, UpdatePositionPayload, UpdateRankPayload } from '@/types/organization'
